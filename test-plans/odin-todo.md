...
- **Sort selection persists after clearing search (regression)**: sort remains applied after clearing the search query.
...
- **Cancel edit leaves original text**: canceling an edit keeps the original title (only if cancel exists).
